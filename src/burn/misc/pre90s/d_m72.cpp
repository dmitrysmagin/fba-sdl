...
{
	int cycles = (int)((float)(((nCurrentCycles - VezCurrentCPU->reg.nec_ICount) + nCyclesDone[0]) * 0.447443125));
...
static void scanline_interrupts(int scanline)
{
	if (scanline == (irq_raster_position - 128) && scanline < 256) {
		...
		VezSetIRQLine(m72_irq_base + 8, VEZ_IRQSTATUS_ACK);
	}
	else if (scanline == 256) // vblank
	{
		...
		VezSetIRQLine(m72_irq_base + 0, VEZ_IRQSTATUS_ACK);
	}
...
struct BurnDriver BurnDrvRtype = {
	...
	rtypeInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvXmultipl = {
	...
	xmultiplInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
static struct BurnRomInfo xmultiplm72RomDesc[] = {
	...
	{ "xmultipl_i8751h.bin",0x10000, 0xc8ceb3cd, 0x00 | BRF_OPT }, // 21 i8751 Code
};
...
struct BurnDriver BurnDrvXmultiplm72 = {
	...
	xmultiplm72Init, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvDbreed = {
	...
	dbreedInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvDbreedm72 = {
	...
	dbreedm72Init, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvBchopper = {
	...
	bchopperInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvMrheli = {
	...
	mrheliInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvNspirit = {
	...
	nspiritInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvNspiritj = {
	...
	nspiritjInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
static struct BurnRomInfo imgfightRomDesc[] = {
	...
	{ "imgfight_i8751h.bin",0x10000, 0xef0d5098, 0x00 | BRF_OPT }, // 18 i8751 Code
};
...
struct BurnDriver BurnDrvImgfight = {
	...
	imgfightInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	256, 384, 3, 4
};
...
struct BurnDriver BurnDrvAirduel = {
	...
	airduelInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	256, 384, 3, 4
};
...
struct BurnDriver BurnDrvRtype2 = {
	...
	rtype2Init, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvHharry = {
	...
	hharryInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvHharryu = {
	...
	hharryuInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvDkgensanm72 = {
	...
	dkgensanm72Init, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvKengo = {
	...
	kengoInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvCosmccop = {
	...
	cosmccopInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvGallop = {
	...
	gallopInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvLoht = {
	...
	lohtInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvLohtb = {
	...
	lohtbInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvPoundfor = {
	...
	poundforInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	256, 384, 3, 4
};
...
struct BurnDriver BurnDrvMajtitle = {
	...
	majtitleInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	384, 256, 4, 3
};
