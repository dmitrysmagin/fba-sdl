...
struct BurnDriver BurnDrvBackfire = {
	...
	backfireInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x800,
	640, 240, 8, 3
};
...
struct BurnDriver BurnDrvBackfirea = {
	...
	backfireaInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x800,
	640, 240, 8, 3
};
