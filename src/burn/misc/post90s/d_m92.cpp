...
void __fastcall m92WriteByte(unsigned int vezAddress, unsigned char byteValue)
{
	...
	switch (vezAddress) {
		...
		case 0xF9008:
			...
			// backup sprite ram for draw, but it will late one frame
...
//		memcpy(RomV33+0xffff0, RomV33+0x7fff0, 0x10);		// V33 Start vector
		...
		VezMapArea(0xc0000, 0xcffff, 0, RomV33 + 0xc0000);	// rom bank /* Mirror of rom:  Used by In The Hunt as protection */
...
struct BurnDriverD BurnDrvInthunt = {
	...
	"In The Hunt (World)\0", NULL, "Irem", "misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_16BIT_ONLY, 2, HARDWARE_MISC_POST90S,
	NULL, inthuntRomInfo, inthuntRomName, hookInputInfo, hookDIPInfo,
	inthuntInit, hookExit, hookFrame, NULL, hookScan, &bRecalcPalette, 
	320, 240, 4, 3
};
